...
<head>
    ...
    <title>Олимпиада по английскому, немецкому и русскому языкам в 2020 году - Немецкий язык</title>
...
<div id="content">
    ...
    <div id="cMain">
        ...
        <div class="part" id="part">
            ...
            <!--<div id="pFirst">
                <div id="insertHead">
                    Прочитайте текст, вставьте в тексте в пропуски следующие слова и словосочетания:
                </div>

                <div id="insertWords">
                    <div class="iWItem">(1) Chips -</div><div class="iWItem iWItemUsed">(1) Chips</div><div class="iWItem">(1) Chips</div><div class="iWItem">(1) Chips</div>
                </div>

                <div id="insertText">
                    <div id="iTPop">
                        <div class="iTPItem">(1) Chips</div>
                    </div>

                    <p class="iTParagraph">Menschen, die durch Technik (1) <span class="iTItem iTItemEmpty"></span> und zum Übermenschen werden, kennen wir eigentlich nur aus.</p>
                </div>
            </div>-->
            <!--<div id="pFirst">
                <div class="tItem">
...
<script src="/resources/js/languages/german.js"></script>
</body>
</html>
